...
// Ref: https://github.com/h65wang/flutter-animated-counter/blob/master/lib/animated_flip_counter.dart
...
class AnimatedNumberText extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    for (int i = 0; i < digits.length - fractionDigits; i++) {
      final digit = _AnimatedSingleDigitText(
...
class _AnimatedSingleDigitText extends StatelessWidget {
  final double value;
  final Duration duration;
  final Curve curve;
  final Size size;
  ...
  const _AnimatedSingleDigitText({
    Key? key,
    required this.value,
