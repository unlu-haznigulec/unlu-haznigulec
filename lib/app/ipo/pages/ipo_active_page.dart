...
class IpoActivePage extends StatefulWidget {
  const IpoActivePage({super.key});

  @override
  State<IpoActivePage> createState() => _IpoActivePageState();
}

class _IpoActivePageState extends State<IpoActivePage> {
    ...
    return Padding(
      ...
      child: PBlocConsumer<IpoBloc, IpoState>(
        ...
        builder: (context, state) {
          return Column(
            children: [
              if (state.currentIpoList.isNotEmpty) ...[
                Row(
