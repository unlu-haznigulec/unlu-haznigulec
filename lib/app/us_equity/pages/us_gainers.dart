...
class UsGainers extends StatefulWidget {
  ...
  @override
  State<UsGainers> createState() => _UsGainersState();
}

class _UsGainersState extends State<UsGainers> {
      ...
      builder: (context, state) {
        ...
        _sortedList = widget.list
          ...
          ..sort((a, b) {
            ...
            return getChangePercentage(b).compareTo(getChangePercentage(a));
          });
        ...
        return Padding(
          ...
          child: Column(
            children: [
              ...
              state.isLoading || state.gainers.isEmpty
                  ? const Padding(
