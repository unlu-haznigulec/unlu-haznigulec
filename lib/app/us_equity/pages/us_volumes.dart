...
class UsVolumes extends StatefulWidget {
  ...
  @override
  State<UsVolumes> createState() => _UsVolumesState();
}

class _UsVolumesState extends State<UsVolumes> {
  ...
  Widget build(BuildContext context) {
    return PBlocBuilder<UsEquityBloc, UsEquityState>(
      ...
      builder: (context, state) {
        ...
        //subscribe olmuş sembol listesi hacime göre sıralama
        _sortedList = widget.list
            ...
            .toList()
          ..sort((a, b) => (b.currentDailyBar?.volume ?? 0).compareTo(a.currentDailyBar?.volume ?? 0));
