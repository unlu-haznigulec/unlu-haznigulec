          ...
          children: [
            ...
            PBlocBuilder<FavoriteListBloc, FavoriteListState>(
                ...
                builder: (context, state) {
                  bool isFavourite = FavoriteListUtils().isFavorite(symbol.symbolCode, SymbolTypes.crypto);
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            symbol.symbolCode.replaceAll(marketEnum.suffix, ''),
