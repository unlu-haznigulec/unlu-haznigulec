...
class StageAnalysisNoLicense extends StatelessWidget {
  const StageAnalysisNoLicense({super.key});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: Grid.l),
        Text(
          L10n.tr('you_do_not_have_stage_analysis_license'),
          style: context.pAppStyle.labelReg14textSecondary,
        ),
        ...
        InkWell(
          ...
          child: Row(
            children: [
              Text(
                L10n.tr('add_stage_analysis_license'),
