...
class DepthNoLicense extends StatelessWidget {
  const DepthNoLicense({super.key});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: Grid.l),
        Text(
          L10n.tr('you_do_not_have_depth_license'),
          style: context.pAppStyle.labelReg14textSecondary,
        ),
